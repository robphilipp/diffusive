...
This type of topology can dramatically improve the performance such calculations. However, this network topology is only an improvement \textit{if} nested method marking is supported\footnote{The reference implementation, \emph{Diffusive}, does not yet support nested diffusion. However, it is on the list of future work, and will be implemented.}. 
