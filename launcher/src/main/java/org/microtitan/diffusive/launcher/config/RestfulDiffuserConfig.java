 ...
 * with {@link org.microtitan.diffusive.annotations.DiffusiveConfiguration} is the method that will be called by the {@link org.microtitan.diffusive.launcher.DiffusiveLauncher}
...
public class RestfulDiffuserConfig {
	 ...
	 * {@link org.microtitan.diffusive.diffuser.restful.RestfulDiffuser} with the specified diffusion end-points and the class path URI
	 * passed to the remote restful diffuser so that it can load classes for which it needs to 
	 * run diffused methods.
	 * 
	 * Sets the default diffuser into the {@link org.microtitan.diffusive.diffuser.KeyedDiffuserRepository}. This is a required step
	...
	/**
	 * Loads the {@link org.microtitan.diffusive.diffuser.strategy.DiffuserStrategy} from the specified file name and its associated XML configuration
	 * {@link Class}. Note that the XML configuration {@link Class} must have a generic argument that extends
	 * the {@link org.microtitan.diffusive.diffuser.strategy.DiffuserStrategyConfigXml} class.
	 * @param fileName The name of the file containing the configuration information for creating the {@link org.microtitan.diffusive.diffuser.strategy.DiffuserStrategy}.
	 * @param clazz The {@link Class} into which the configuration information is loaded. Note that the class
	 * must extend the {@link org.microtitan.diffusive.diffuser.strategy.DiffuserStrategyConfigXml} class.
	 * @return The loaded {@link org.microtitan.diffusive.diffuser.strategy.DiffuserStrategy}
	 */
