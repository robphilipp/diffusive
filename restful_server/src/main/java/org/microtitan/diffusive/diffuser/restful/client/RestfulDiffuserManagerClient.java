...
public class RestfulDiffuserManagerClient {
	...
	/**
	 * Constructs a {@link org.microtitan.diffusive.diffuser.restful.client.RestfulDiffuserManagerClient} that connects to a {@link org.microtitan.diffusive.diffuser.restful.server.RestfulDiffuserServer} with
	 * an end-point at the specified base URI. The base URI is the starting point to which diffuser-specific path
	 * information is added.
	 * @param baseUri The {@link org.microtitan.diffusive.diffuser.restful.server.RestfulDiffuserServer} end-point to which this client connects
	 */
	...
	/**
	 * Converts a {@link java.util.List} of {@link java.net.URI} into a {@link java.util.List} of {@link String}s that represent the
	 * {@link java.net.URI}. Effectively, iterates through the list of URI calling the {@link java.net.URI#toString()} method
	 * on each and adding that to the return list.
	 * @param classPathUri The URI representing the remote class path
	 * @return a {@link java.util.List} of URI represented as {@link String}s.
	 */
	 ...
	 * @param serializer The {@link org.microtitan.diffusive.diffuser.serializer.Serializer} used to serialize and de-serialize the object
	 * @return An {@link org.microtitan.diffusive.diffuser.restful.response.ExecuteDiffuserResponse} object containing the information about the result and the
	 ...
	 * @param serializedObject A {@code byte[]} representation of the object of the {@link Class} that contains 
	 * the diffusive method being called
	 * @param serializerType The name of the {@link org.microtitan.diffusive.diffuser.serializer.Serializer} used to serialize and de-serialize the object
	 * @return An {@link org.microtitan.diffusive.diffuser.restful.response.ExecuteDiffuserResponse} object containing the information about the result and the
	 * underlying Atom feed.
	 */
	public ExecuteDiffuserResponse executeMethod( final Class< ? > returnTypeClazz, 
	 ...
	 * @param serializerType The name of the {@link org.microtitan.diffusive.diffuser.serializer.Serializer} used to serialize and deserialize the object
	 * @return An {@link org.microtitan.diffusive.diffuser.restful.response.ExecuteDiffuserResponse} object containing the information about the result and the
	 * underlying Atom feed.
	 */
