...
/**
 * Encapsulates the key used to identify a {@link org.microtitan.diffusive.diffuser.Diffuser} for a specific method. The {@link org.microtitan.diffusive.diffuser.Diffuser} ID
 * is based on:
 * <ul>
 ...
 * </ul>
 * The {@link org.microtitan.diffusive.diffuser.Diffuser} ID is constructed as follows:<p>
 ...
 * 
 * The {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature} can be instantiated through the constructors, or preferably, through one of the
 * four {@code create(...)} methods, or the {@link #parse(String)} method.
 * 
 * The {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature} objects are immutable.
 * 
...
public class DiffuserSignature implements Copyable< DiffuserSignature > {
	...
	/**
	 * Constructs a {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature} based on the specified return type name, the name of the class containing the
	...
	/**
	 * Constructs a {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature} for a method that does not return a value, the name of the class containing the
	 * diffusive method, the method to diffuse, and the list of argument type names. 
	 * @param className The name of the class that contains the method to diffuse
	 * @param methodName The name of the method to diffuse
	 * @param argumentTypes The class names of the arguments passed to the method
	...
	/**
	 * Constructs a {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature} by parsing an existing diffuser ID string. The {@link org.microtitan.diffusive.diffuser.Diffuser} ID
	...
	/**
	 * Copy constructor that creates a copy of the specified diffuser ID. {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature} objects are
	 * immutable, so this isn't terribly necessary. 
	 * @param id The {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature} to copy
	 */
	...
	/**
	 * Constructs a {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature} for a method that doesn't have a return value
	 * @param clazz The {@link Class} that contains the diffused method
	 * @param methodName The name of the diffused method
	 * @param argumentTypes The {@link Class} objects of the arguments passed into the diffused method
	 * @return a {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature} for a method that doesn't have a return value
	 */
	...
	/**
	 * Constructs a {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature}
	 * @param returnType The {@link Class} object representing the method's return type
	 * @param clazz The {@link Class} that contains the diffused method
	 * @param methodName The name of the diffused method
	 * @param argumentTypes The {@link Class} objects of the arguments passed into the diffused method
	 * @return a {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature}
	 */
	...
	/**
	 * Constructs the {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature}, for a method that does not return a value, based on
	 * the specified values
	 * @param containingClassName The name of the class that contains the method to diffuse
	 * @param methodName The name of the method to diffuse
	 * @param argumentTypes The class names of the arguments passed to the method
	 * @return the {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature} based on the specified values
	 */
	...
	/**
	 * Constructs the {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature} based on the specified values
	 * @param returnType The name of the return type
	 * @param containingClassName The name of the class that contains the method to diffuse
	 * @param methodName The name of the method to diffuse
	 * @param argumentTypes The class names of the arguments passed to the method
	...
	/**
	 * Returns true if the specified signature is a valid signature; false otherwise. The {@link org.microtitan.diffusive.diffuser.Diffuser} ID
	 * is constructed as follows:<p>
	 * {@code class:method(argument1,argument2,argument3,...,argumentN)-returnType}<p> 
	 * where the "{@code class}" is the fully qualified class name; the method is the name of the method;
	 * the arguments are all the fully qualified class names of the argument; and the {@code returnType}
	...
	/**
	 * Parses the specified diffuser ID string into a {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature} object. The {@link org.microtitan.diffusive.diffuser.Diffuser} ID
	 * is constructed as follows:<p>
	 * {@code class:method(argument1,argument2,argument3,...,argumentN)-returnType}<p> 
	 * where the "{@code class}" is the fully qualified class name; the method is the name of the method;
	 * the arguments are all the fully qualified class names of the argument; and the {@code returnType}
	 ...
	 * @return a {@link org.microtitan.diffusive.diffuser.restful.DiffuserSignature} object based on the specified diffuser ID string
	 */
