...
public class ClassRequest {
	...
	/**
	 * Constructs a new {@link org.microtitan.diffusive.diffuser.restful.request.ClassRequest} with the specified URI base URI to the
	 ...
	 * @param baseUri the base {@link java.net.URI} to the web resource
	...
	/**
	 * Creates and returns a new {@link org.microtitan.diffusive.diffuser.restful.request.ClassRequest} with the specified URI base URI to the
	 * resource and the fully qualified class name for the {@link Class} to retrieve. The full
	 * URI to the {@link Class} is given by concatenating  the base URI and the class name.
	 * @param baseUri the base {@link java.net.URI} to the web resource
	 * @param className the fully qualified class name of the {@link Class} to retrieve
	 * @return a new {@link org.microtitan.diffusive.diffuser.restful.request.ClassRequest}
	 */
	...
	/**
     * @return the base {@link java.net.URI} to the web resource
     */
