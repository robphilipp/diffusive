 ...
 * The {@link org.microtitan.diffusive.diffuser.restful.server.KeyedDiffusiveStrategyRepository.SharedRegistry} is the shared registry, but others can be created with different
 * keys as needed.
 * 
...
public class KeyedDiffusiveStrategyRepository {
	...
	/**
	 * @return the shared instance of the diffusive strategy repository. Sets the {@link org.microtitan.diffusive.diffuser.strategy.DiffuserStrategy}
	 * to the {@link #DEFAULT_STRATEGY} ({@link org.microtitan.diffusive.diffuser.strategy.RandomDiffuserStrategy}), and the load threshold to
	 * the {@link #DEFAULT_LOAD_THRESHOLD} = {@value #DEFAULT_LOAD_THRESHOLD}.
	 * @see #setLoadThreshold(double)
	 * @see #setStrategy(org.microtitan.diffusive.diffuser.strategy.DiffuserStrategy)
	 * @see #setValues(org.microtitan.diffusive.diffuser.strategy.DiffuserStrategy, double)
	 */
	 ...
	 * already exist. Sets the {@link org.microtitan.diffusive.diffuser.strategy.DiffuserStrategy} to the {@link #DEFAULT_STRATEGY}
	 * ({@link org.microtitan.diffusive.diffuser.strategy.RandomDiffuserStrategy}), and the load threshold to the {@link #DEFAULT_LOAD_THRESHOLD}
	...
	/**
	 * Constructor that sets the default {@link org.microtitan.diffusive.diffuser.strategy.DiffuserStrategy} and load threshold
	 */
	...
	/**
	 * @return the {@link org.microtitan.diffusive.diffuser.strategy.DiffuserStrategy} set
	 */
	...
	/**
	 * Sets the {@link org.microtitan.diffusive.diffuser.strategy.DiffuserStrategy} and returns the previous value (if there is one)
	 * @param strategy The new {@link org.microtitan.diffusive.diffuser.strategy.DiffuserStrategy}
	 * @return The previous {@link org.microtitan.diffusive.diffuser.strategy.DiffuserStrategy} assigned to this registry
	 */
	...
	/**
	 * Allows registering a {@link java.beans.PropertyChangeListener} to receive property change events
	 * when the strategy or load threshold are changed.
	 * @param listener The {@link java.beans.PropertyChangeListener} to register
	 */
	...
	/**
	 * Removes the specified {@link java.beans.PropertyChangeListener} from receiving change events.
	...
	/**
	 * Fires a {@link java.beans.PropertyChangeEvent} for the specified change
